...
// This uses the User package to get stuff from the DB

import (
	"github.com/cjh-cloud/collective/go/src/go-serverless-stack/pkg/user"
	"net/http"
...
// E.g. someone tries using PATCH method
func UnhandledMethod(method events.APIGatewayProxyRequest)(*events.APIGatewayProxyResponse, error) {
	return apiResponse(http.StatusMethodNotAllowed, method)
}