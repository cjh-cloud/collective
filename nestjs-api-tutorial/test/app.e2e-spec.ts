...
describe('App e2e', () => {
  ...
  describe('Bookmark', () => {
    ...
    // TODO - request is OK 200 if no body is sent
    describe('Edit bookmark by id', () => {
      const dto: EditBookmarkDto = {
        ...
        NestJs is a rapidly growing node js framework that helps build scalable and maintainable backend applications.",
      }
